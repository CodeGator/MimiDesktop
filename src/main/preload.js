...
contextBridge.exposeInMainWorld('vault', {
  ...
  getDataFileSerializationVersion: () => ipcRenderer.invoke('vault:getDataFileSerializationVersion'),
  getFileEnvelopeVersion: () => ipcRenderer.invoke('vault:getFileEnvelopeVersion'),
  ...
  exportApiKeys: (apiKeys, password) => ipcRenderer.invoke('vault:exportApiKeys', apiKeys, password),
  importApiKeys: () => ipcRenderer.invoke('vault:importApiKeys'),
  importApiKeysWithPassword: (filePath, password) => ipcRenderer.invoke('vault:importApiKeysWithPassword', filePath, password),
